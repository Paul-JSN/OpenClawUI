...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    communications: "Curated channel, delivery, broadcast, and voice configuration.",
    appearance: "UI polish, layout preferences, and visual host settings.",
    automation: "Scheduled runs, commands, hooks, and automation tooling.",
    infrastructure: "Gateway runtime, web entry points, discovery, logging, and updates.",
    aiAgents: "Agent, model, skill, auth, and tool-access scaffolding.",
