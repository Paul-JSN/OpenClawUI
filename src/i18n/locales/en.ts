...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    models: "Manage model providers, aliases, and deletions.",
    ...
    communications: "Scoped config for channels, messaging, broadcast, and audio delivery.",
    appearance: "Scoped config for UI, themes, and onboarding presentation.",
    automation: "Scoped config for commands, hooks, bindings, cron, and plugin automation.",
    infrastructure: "Scoped config for gateway, web, browser, discovery, media, and remote hosts.",
    aiAgents: "Scoped config for agents, models, tools, skills, memory, and session behavior.",
