...
export const zh_TW: TranslationMap = {
  ...
  subtitles: {
    ...
    communications: "聚焦頻道、訊息、廣播與音訊投遞的設定。",
    appearance: "聚焦介面、主題與引導呈現的設定。",
    automation: "聚焦命令、hooks、bindings、cron 與外掛自動化的設定。",
    infrastructure: "聚焦閘道、Web、瀏覽器、探索、媒體與遠端主機的設定。",
    aiAgents: "聚焦代理、模型、工具、技能、記憶與會話行為的設定。",
