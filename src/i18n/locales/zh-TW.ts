...
export const zh_TW: TranslationMap = {
  ...
  subtitles: {
    ...
    communications: "集中管理頻道、投遞、廣播與語音相關配置。",
    appearance: "介面外觀、版面偏好與視覺宿主設定。",
    automation: "排程工作、命令、掛鉤與自動化工具設定。",
    infrastructure: "網關執行環境、Web 入口、探索、日誌與更新設定。",
    aiAgents: "代理、模型、技能、驗證與工具存取腳手架。",
