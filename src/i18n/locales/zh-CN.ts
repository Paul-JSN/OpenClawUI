...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    ...
    models: "管理模型提供商、别名和删除。",
    cron: "安排唤醒和重复的代理运行。",
    skills: "管理技能可用性和 API 密钥注入。",
    nodes: "配对设备、功能和命令公开。",
    chat: "用于快速干预的直接网关聊天会话。",
    communications: "聚焦频道、消息、广播与音频投递的配置。",
    appearance: "聚焦界面、主题与引导呈现的配置。",
    automation: "聚焦命令、hooks、bindings、cron 与插件自动化的配置。",
    infrastructure: "聚焦网关、Web、浏览器、发现、媒体与远程主机的配置。",
    aiAgents: "聚焦代理、模型、工具、技能、记忆与会话行为的配置。",
