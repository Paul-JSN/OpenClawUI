...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    ...
    communications: "集中管理频道、投递、广播和语音相关配置。",
    appearance: "界面外观、布局偏好和视觉宿主设置。",
    automation: "计划任务、命令、钩子和自动化工具设置。",
    infrastructure: "网关运行时、Web 入口、发现、日志和更新设置。",
    aiAgents: "代理、模型、技能、认证和工具访问脚手架。",
