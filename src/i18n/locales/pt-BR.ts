...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    communications: "Configuração curada de canais, entrega, broadcast e voz.",
    appearance: "Ajustes de UI, preferências de layout e host visual.",
    automation: "Execuções agendadas, comandos, hooks e ferramentas de automação.",
    infrastructure: "Runtime do gateway, web, descoberta, logs e atualizações.",
    aiAgents: "Scaffold de agentes, modelos, habilidades, auth e ferramentas.",
