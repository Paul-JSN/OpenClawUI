...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    communications: "Configurações focadas em canais, mensagens, broadcast e áudio.",
    appearance: "Configurações focadas em UI, temas e apresentação do assistente.",
    automation: "Configurações focadas em comandos, hooks, bindings, cron e plugins.",
    infrastructure: "Configurações focadas em gateway, web, navegador, descoberta, mídia e hosts remotos.",
    aiAgents: "Configurações focadas em agentes, modelos, ferramentas, skills, memória e sessão.",
