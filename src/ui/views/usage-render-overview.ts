      ...
      <div class="daily-chart">
        <div class="daily-chart-bars" style="--bar-max-width: ${barMaxWidth}px">
          ${daily.map((d, idx) => {
            ...
            const label = formatDayLabel(d.date, displayTimeZone);
            ...
            return html`
              ...
              >
                ...
                <div class="daily-bar-tooltip">
                  <strong>${formatFullDate(d.date, displayTimeZone)}</strong><br />
  ...
  return html`
    <div class="usage-insight-card">
      <div class="usage-insight-title">
        ${icon ? html`<span class="usage-insight-icon">${icon}</span>` : nothing}
        ${title}
      </div>
      ${
        items.length === 0
...
function renderUsageInsights(
  ...
  const errorDays = aggregates.daily
    ...
    .map((day) => {
      ...
      return {
        label: formatDayLabel(day.date, displayTimeZone),
    ...
    <section class="card" style="margin-top: 16px;">
      ...
      <div class="usage-insights-grid">
        ${renderInsightList("Top Models", topModels, "No model data",
          html`<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>`)}
        ${renderInsightList("Top Providers", topProviders, "No provider data",
          html`<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="2" y="3" width="20" height="7" rx="2"/><rect x="2" y="14" width="20" height="7" rx="2"/></svg>`)}
        ${renderInsightList("Top Tools", topTools, "No tool calls",
          html`<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>`)}
        ${renderInsightList("Top Agents", topAgents, "No agent data",
          html`<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>`)}
        ${renderInsightList("Top Channels", topChannels, "No channel data",
          html`<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>`)}
        ${renderPeakErrorList("Peak Error Days", errorDays, "No error data",
          html`<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>`)}
        ${renderPeakErrorList("Peak Error Hours", errorHours, "No error data",
          html`<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>`)}
      </div>
    </section>
  `;
}
