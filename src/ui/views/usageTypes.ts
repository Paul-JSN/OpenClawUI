...
export type UsageSectionId =
  ...
  | "dailyTokenUsage"
  | "sessions";
export type UsageSectionCollapseState = Record<UsageSectionId, boolean>;

export type UsageProps = {
  loading: boolean;
  error: string | null;
  usageStatus: UsageSummary | null;
  analyticsView: UsageAnalyticsViewModel;
  startDate: string;
  endDate: string;
  ...
  usageSectionCollapsed: UsageSectionCollapseState;
  ...
  onToggleUsageSection: (section: UsageSectionId) => void;
};
