...
import type { UsageSectionCollapseState } from "./views/usageTypes.ts";
import type { DisplayTimeZone } from "./views/charts/timezone.ts";
...
export type AppViewState = {
  ...
  usageDisplayTimeZone: DisplayTimeZone;
